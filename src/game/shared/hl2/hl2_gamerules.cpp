...
ConVar	sk_dmg_inflict_scale1( "sk_dmg_inflict_scale1", "6.50", FCVAR_REPLICATED );
ConVar	sk_dmg_inflict_scale2( "sk_dmg_inflict_scale2", "2.00", FCVAR_REPLICATED );
ConVar	sk_dmg_inflict_scale3( "sk_dmg_inflict_scale3", "1.75", FCVAR_REPLICATED );
